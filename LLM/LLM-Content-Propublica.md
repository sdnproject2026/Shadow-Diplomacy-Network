...
##  Raw CSV ProPublica Data Store

- https://raw.githubusercontent.com/propublica/compas-analysis/master/compas-scores-two-years.csv

- https://raw.githubusercontent.com/propublica/compas-analysis/master/cox-violent-parsed.csv

- https://raw.githubusercontent.com/propublica/compas-analysis/master/cox-violent-parsed_filt.csv

- https://raw.githubusercontent.com/algofairness/compas-analysis/master/compas-scores-two-years.csv

- https://raw.githubusercontent.com/dssg/aequitas/master/examples/data/compas_demo_binarized.csv

- https://raw.githubusercontent.com/Trusted-AI/AIF360/master/aif360/data/raw/compas/compas-scores-two-years.csv

# GitLab 

## Raw CSV Endpoints

- https://gitlab.com/atmamani/compas-analysis/-/raw/master/compas-scores-two-years.csv

- https://gitlab.com/mirror-propublica/compas-analysis/-/raw/master/cox-violent-parsed.csv

# Academic 

##  Direct CSV Mirrors

- https://people.cs.umass.edu/~ribeiro/data/compas.csv

# ProPublica Data Store 

## Direct CSV And ZIP

- https://projects.propublica.org/datastore/datasets/20160919-Amazon-Ranking-Analysis.csv.zip

- https://projects.propublica.org/datastore/datasets/PP-Data-Store-HPI-Impact-of-Tax-Plan.csv

# Kaggle 

## Cloud Storage Mirrors

- https://storage.googleapis.com/kaggle-data-sets/compas-scores-two-years.csv

# Gist 

## Paste Raw Patterns

- https://gist.githubusercontent.com/anonymous/COMPAS/raw/compas-scores-two-years.csv
...
What additional ProPublica datasets beyond COMPAS have publicly mirrored CSV files available across repositories

Which GitHub repositories contain full untouched exports of ProPublica Data Store datasets rather than transformed subsets

Are there archived torrents or bulk dumps of the ProPublica Data Store CSV collections available

Which datasets from the ProPublica Data Store are least likely to have been mirrored publicly

What patterns can be used to systematically discover additional raw CSV mirrors across GitHub and GitLab

-----

# ProPublica Scrape

- https://r.jina.ai/https://www.propublica.org/article/trump-administration-financial-disclosures-steve-feinberg

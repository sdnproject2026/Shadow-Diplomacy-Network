given blocks of email addresses respond with blocks of email address verbatim, retain formatting also, add after the CSV comma separated list of email address ### Count, all CSV and ^ prefixed email addresses per block

# SDN-Sent-13-Email-To
